...
q1<-RJDemetra::tramoseats(indprod$M.PROD.C.NSA.I15.DE, spec1)

spec2<-tramoseats_spec(spec1, estimate.last=120)
q2<-RJDemetra::tramoseats(indprod$M.PROD.C.NSA.I15.DE, spec2)
...
q3<-RJDemetra::tramoseats(indprod$M.PROD.C.NSA.I15.DE, spec3)
